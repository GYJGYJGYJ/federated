...
dummy_stateful_mean = tff.utils.IterativeProcess(
...
def build_model_delta_optimizer_process(model_fn,
                                        ...
                                        server_optimizer_fn,
                                        stateful_delta_aggregator=None):
  ...
  if stateful_delta_aggregator is None:
    stateful_delta_aggregator = dummy_stateful_mean
  py_typecheck.check_type(stateful_delta_aggregator, tff.utils.IterativeProcess)
  ...
  def server_init_tff():
    ...
    server_init_tf = tff.tf_computation(lambda: server_init(  # pylint: disable=g-long-lambda
        model_fn, server_optimizer_fn, stateful_delta_aggregator.initialize()))
